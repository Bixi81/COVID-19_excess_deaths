...
- The estimated number of excess deaths *beyond* the official number of reported Covid-19 deaths is in the range between 0 and 170 deaths per day (95% CI), with an expected values of 93 deaths per day (4% against the overall mean; OLS model). 
